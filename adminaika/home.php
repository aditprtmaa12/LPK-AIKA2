      ...
      <div class="app-title">
        <div>
          ...
          <p>Selamat Datang <b><?= $user['nama_user'] ?></b> </p>
        </div>
      ...
      <div class="tab-pane fade show active" id="home5" role="tabpanel" aria-labelledby="home-tab5">
        <form id="form-setting1">
            <div class="card" id="settings-card">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Nama Universitas</label>
                        <div class="col-sm-6 col-md-9">
                            <input type="text" name="nama" class="form-control" value="<?= $setting['nama_sekolah'] ?>" required>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label for="site-description" class="form-control-label col-sm-3 text-md-right">Jenjang Pendidikan</label>
                        <div class="col-sm-6 col-md-9">
                            ...
                            <select name="jenjang"  class="form-control input-sm input-select"value="<?= $setting['jenjang'] ?>" >
								  <option value="<?= $setting['jenjang'] ?>" >
										...
										<?php } elseif ($setting['jenjang'] == 2) { ?>
											<span class="badge badge-danger">S2</span>
										<?php } else { ?>
										<?php } ?>
								  </option>
                    ...
                    <div class="form-group row align-items-center">
                        <label for="site-description" class="form-control-label col-sm-3 text-md-right">Status Lembaga</label>
                        <div class="col-sm-6 col-md-9">
