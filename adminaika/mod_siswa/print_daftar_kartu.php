    ...
    <tr>
        <td>
            ...
            <div align="center" class="style13">
                    <b>KARTU PENDAFTARAN SISWA BARU TAHUN PELAJARAN <?= $setting['tahun_pelajaran'] ?> </b>
            </div>
                        ...
                        <table style="font-size: 11pt;" class="table table-striped table-sm table-bordered" cellspacing="0" id="sampleTable">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="5"> Note : 
									<br>Kartu ini merupakan Hasil isian Data saya di Website Portal PPDB Online
									<br>Calon Siswa Bertanggung Jawab Penuh Atas Seluruh Isian data di Formulir ini
									<br>
									<br><b style="margin-left:150px">Ketua Panitia
									<br>
									<br><img class="img" src="../../<?= $setting['ttd'] ?>" ec="H" style="width: 30mm; z-index: 800;position:absolute;margin-top:-20px;margin-left:120px" class="img" src="<?= $skl['ttd'] ?>"">
                                    <br>
                                    <br>
                                    <br>
                                    <br>
                                    <br>
										<b style="margin-left:150px">Suyanto, S. Pd</b>
                                    </td>
