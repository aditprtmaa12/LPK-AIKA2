                    ...
                    <div class="card-body pb-0">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <a target="" href="?pg=berkas" type="button" class="btn btn-success"><i class="fa fa-upload    "></i> Progres Kegiatan</a>
...
<div class="row">
    <div class="col-md-8 mb-3">
        <form id="form-simpan-berkas">
            <input type="hidden" value="<?= $siswa['id_siswa'] ?>" name="id_siswa" class="form-control">
            <div class="card" id="berkas-card">
                <div class="card-body">
                    <div class="form-group row align-items-center">
                        <label class="form-control-label col-sm-3 text-md-right">Tanggal</label>
                        <div class="col-sm-6 col-md-9">
                            <input type="date" id="tanggal" name="tanggal" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label class="form-control-label col-sm-3 text-md-right">Laporan kegiatan</label>
                        <div class="col-sm-6 col-md-9">
                            <input type="text" name="laporan" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label class="form-control-label col-sm-3 text-md-right">Kode</label>
                        <div class="col-sm-6 col-md-9">
                            <input type="text" name="kode" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label class="form-control-label col-sm-3 text-md-right">Foto Kegiatan</label>
                        <div class="col-sm-6 col-md-9">
                            <div class="custom-file">
                                <input type="file" name="file_laporan" class="custom-file-input" id="site-akta" accept="image/*">
                                <label class="custom-file-label">Choose File</label>
                            </div>
                            <div class="form-text text-muted">File bisa berupa gambar</div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('#form-simpan-berkas').on('submit', function(e) {
        e.preventDefault();

        $.ajax({
            type: 'post',
            url: 'content/crud.php?pg=simpan_berkas',
            ...
            success: function(data) {
                if (data.trim() == 'success') {
                    ...
                    swal({
                        title: 'Gagal',
                        text: 'Data Gagal di Ajukan: ' + data,
                        type: 'error',
                        buttons: true,
                    });
                }
