...
<?php if ($siswa['status'] == 1) { ?>
	<div class="alert alert-success alert-dismissable">
		...
		Terima kasih, Data Anda Sudah di Konfirmasi Oleh Panitia, Selanjutnya Syarat mengikuti ITTIBA DAN UK sebagai berikut :<br /><br />
		1.  Peserta melakukan Pembayaran melalui Loket/Biro Keuangan UMT<br />
		2.  Kemudian mengisi data peserta dan data pekerjaan<br />
		3.  ⁠Selamat anda menjadi Peserta ITTIBA DAN UK 2024<br/>		
	</div>
			 ...
			 <div class="col-md-4 mb-3">
              <div class="card">
                <div class="card-body">
				  ...
				  <?php if ($siswa['foto'] == '') { ?>
                    <img src="../default.png" alt="Foto Mahasiswa" class="rounded-circle" width="150">
					<?php } else { ?>
