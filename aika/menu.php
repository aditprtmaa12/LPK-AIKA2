...
<ul class="app-menu">
	...
	<li><a class="app-menu__item" href="?pg=berkas"><i class="app-menu__icon fa fa-upload"></i><span class="app-menu__label">Progres Kegiatan</span></a></li>
	<li><a class="app-menu__item" href="?pg=sertifikat"><i class="app-menu__icon fa fa-money"></i><span class="app-menu__label">E-Certificate</span></a></li>
