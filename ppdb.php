...
<head>
    ...
    <title>Pendaftaran ITTIBA DAN UK Online | <?= $setting['nama_sekolah'] ?></title>
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
                    ...
                    <span style="margin-left:45px;">&nbsp;Pendaftaran ITTIBA DAN UK Online</span>
                </a>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name shad" style="font-size:35px; line-height: 35px;">
                            SELAMAT DATANG DI Pendaftaran ITTIBA DAN UK ONLINE <br> <?= $setting['nama_sekolah'] ?>                        </span>
                        <br>
                                                    <span>
    ...
    <header>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name shad" style="font-size:35px; line-height: 35px;">
                            Selamat Datang di Web Pendaftaran ITTIBA DAN & UK 2024 <br> <?= $setting['nama_sekolah'] ?>                        </span>
                        <br>
                                                    <span>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom bxshad">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
                    <img src="<?= $url ?>/<?= $setting['logo'] ?>" alt="Logo" width="35" style="position:absolute;margin-top:-10px;">
                    <span style="margin-left:45px;">&nbsp;Pendaftaran ITTIBA DAN UK</span>
                </a>
            </div>
        ...
        <div class="container">
            <div class=" row">
                <div class="col-lg-12 text-center">
                    <h2>Informasi Pendaftaran ITTIBA DAN UK</h2>
                    <hr style="width: 150px;">
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2" style="text-align:justify; line-height: 22px;">
                    <p><?= $setting['nama_sekolah'] ?> menyediakan Pendaftaran ITTIBA DAN UK secara <i>online</i> diharapkan proses Pendaftaran ITTIBA DAN UK dapat berjalan cepat
                        dan bisa dilakukan dimanapun dan kapanpun selama sesi pendaftaran ITTIBA DAN UK Online dibuka. Proses pendaftaran calon siswa baru di masa pandemi Covid-19 ini dan terhambat oleh jarak jika datang ke madrasah langsung, bisa mengakses website Pendaftaran ITTIBA DAN UK Online <?= $setting['nama_sekolah'] ?>. </p>
                </div>
                <div class="col-lg-4" style="text-align:justify; line-height: 22px;">
                    <p>Pengisian form Pendaftaran ITTIBA DAN UK Online mohon diperhatikan data yang dibutuhkan yang nantinya akan dipakai dalam proses Pendaftaran ITTIBA DAN UK. Setelah proses pengisian form Pendaftaran ITTIBA DAN UK secara online berhasil dilakukan, calon siswa akan mendapat bukti daftar dengan nomor pendaftaran dan harus disimpan yang akan digunakan untuk proses selanjutnya.</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12" style="margin-top:-10px;">
                    ...
                    <div class="col-md-8">
                        <h4 align="center">Pendaftaran ITTIBA DAN UK Online &copy; <?= $setting['nama_sekolah'] ?> <br><?= $setting['alamat'] ?></h4>
    ...
    <footer class="text-center">
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Pendaftaran ITTIBA DAN UK Online &copy; <?= $setting['nama_sekolah'] ?>                  </div>
                </div>
            </div>
        </div>
    </footer>
