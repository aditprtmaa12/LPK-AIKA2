                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name shad" style="font-size:35px; line-height: 35px;">
                            SELAMAT DATANG DI PENDAFTARAN ITTIBA DAN UK <br> <?= $setting['nama_sekolah'] ?>                        </span>
                        <br>
                                                    <span>
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2" style="text-align:justify; line-height: 22px;">
                    <p><?= $setting['nama_sekolah'] ?> menyediakan PPDB secara <i>online</i> diharapkan proses PPDB dapat berjalan cepat
                        dan bisa dilakukan dimanapun dan kapanpun selama sesi PENDAFTARAN ITTIBA DAN UK dibuka. Proses pendaftaran calon siswa baru di masa pandemi Covid-19 ini dan terhambat oleh jarak jika datang ke madrasah langsung, bisa mengakses website PPDB Online <?= $setting['nama_sekolah'] ?>. </p>
                </div>
                <div class="col-lg-4" style="text-align:justify; line-height: 22px;">
                    <p>Pengisian form PENDAFTARAN ITTIBA DAN UK mohon diperhatikan data yang dibutuhkan yang nantinya akan dipakai dalam proses PPDB. Setelah proses pengisian form PPDB secara online berhasil dilakukan, calon siswa akan mendapat bukti daftar dengan nomor pendaftaran dan harus disimpan yang akan digunakan untuk proses selanjutnya.</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12" style="margin-top:-10px;">
                    ...
                    <div class="col-md-8">
                        <h4 align="center">PENDAFTARAN ITTIBA DAN UK &copy; <?= $setting['nama_sekolah'] ?> <br><?= $setting['alamat'] ?></h4>
    ...
    <footer class="text-center">
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        PENDAFTARAN ITTIBA DAN UK &copy; <?= $setting['nama_sekolah'] ?>                  </div>
                </div>
            </div>
        </div>
    </footer>
